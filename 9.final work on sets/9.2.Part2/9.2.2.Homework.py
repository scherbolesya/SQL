...
# Input format
# The numbers n,m,k,p are given as input to the program, each on a separate line.
# Output format
# The program should display the number of students who have completed their homework.
