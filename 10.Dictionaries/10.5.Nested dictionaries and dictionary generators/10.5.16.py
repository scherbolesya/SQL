...
# Complete the following code using a generator to produce a result list containing nested dictionaries as follows: [{'S001': {'Camila Rodriguez': 86}}, {'S002': {'Juan Cruz': 98} },...].
# Note 1: To iterate through all three lists in parallel at the same time, you can use the built-in zip() function.
# Note 2: There is no need to display the contents of the result list.
