...
# Complete the following code using a generator to produce a result dictionary consisting of all the elements in the colors dictionary except those whose value is None.
