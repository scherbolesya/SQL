...
# Complete the code below to display the names of all users (in alphabetical order) whose number ends with 8.
# Note. Names must be printed on one line, separated by a space character.
